      ...
      <Box sx={{ pb: 7 }}>
        ...
        >
          <BottomNavigation showLabels>
            <Link
              href={`/store/${params.client}/${drinkItems[0].category}/${params.productID}`}
            >
              <BottomNavigationAction label="Details" icon={<InfoIcon />} />
            </Link>

            <Link
              href={`/store/${params.client}/${drinkItems[0].category}/${params.productID}/Comments`}
              className=""
            >
            ...
            <Link
              href={`/store/${params.client}/${drinkItems[0].category}/${params.productID}/Share`}
              className=""
            >
